...
export async function createAccountProfile(accountId, input = {}) {
  ...
  const profile = {
    ...
    library: { favorites: [], savedSelections: { series: [], movies: [], live: [] }, streaming_history: { episodes: [], movies: [], live: [] }, series_last_watched: [], last_kinds_watched: { episode: null, movie: null, live: null } },
